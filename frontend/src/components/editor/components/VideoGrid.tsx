...
export default function VideoGrid({ jobs, template, onCalibrate, onRemove, onToggleMirror, onToggleKeepTitle, onDownload, antiDuplicityEnabled, textOverlay, imageOverlay, keepTitle, onUpdateTextOverlay, onUpdateImageOverlay }: VideoGridProps) {
  return (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4">
          {jobs.map((job) => (
            <VideoCard
              ...
              onToggleKeepTitle={onToggleKeepTitle}
